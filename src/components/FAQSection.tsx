...
export const FAQSection = () => {
  ...
  const faqs = [
    { category: 'general', question: 'What is Winbox?', answer: 'Winbox is a premier online casino platform in Malaysia, offering a wide range of games including slots, live casino, and sports betting with a focus on security and player experience.' },
    { category: 'general', question: 'Is Winbox legal in Malaysia?', answer: 'Winbox operates under international gaming licenses from Gaming Curacao and PAGCOR, ensuring a regulated and fair gaming environment for all players.' },
    ...
    { category: 'account', question: 'How do I create an account?', answer: 'Simply click the "Register" button, provide your basic details, and verify your phone number to start your journey with Winbox.' },
    ...
    { category: 'games', question: 'Can I play on my mobile phone?', answer: 'Absolutely! Winbox is fully optimized for mobile browsers, and we also offer a dedicated app for both iOS and Android devices.' },
    ...
    { category: 'security', question: 'How does Winbox protect my data?', answer: 'We use advanced SSL encryption and security protocols from iovation and ThreatMetrix to ensure your personal and financial data remains private.' },
